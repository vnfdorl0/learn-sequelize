...
class User extends Sequelize.Model {
    ...
    static initiate(sequelize) {
        ...
        User.init({
            ...
            nuderscored: false, // 카멜 케이스(예시: createdAt) 컬럼.테이블명 사용
            ...
            // true로 설정 -> 로우를 삭제할 때 완전히 지워지지 않고 deletedAt에 지운 시각이 지록됨(로우 복원 가능)
            charset: 'utf8', // 문자 인코딩
            collate: 'utf8_general_ci', // 문자 정렬
            // 한글 입력 -> charset: 'utf8', collate: 'utg8_general_ci'로 설정
